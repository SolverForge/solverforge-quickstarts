...
def test_room_conflict():
    ...
    non_conflicting_lesson = Lesson(
        "3", "Subject3", "Teacher3", "Group3", TIMESLOT2, ROOM1
    )
    (
...
def test_teacher_conflict():
    ...
    first_lesson = Lesson(
        "1", "Subject1", conflicting_teacher, "Group1", TIMESLOT1, ROOM1
    )
    conflicting_lesson = Lesson(
        "2", "Subject2", conflicting_teacher, "Group2", TIMESLOT1, ROOM2
    )
    non_conflicting_lesson = Lesson(
        "3", "Subject3", "Teacher2", "Group3", TIMESLOT2, ROOM1
    )
    (
...
def test_student_group_conflict():
    ...
    first_lesson = Lesson(
        "1", "Subject1", "Teacher1", conflicting_group, TIMESLOT1, ROOM1
    )
    conflicting_lesson = Lesson(
        "2", "Subject2", "Teacher2", conflicting_group, TIMESLOT1, ROOM2
    )
    non_conflicting_lesson = Lesson(
        "3", "Subject3", "Teacher3", "Group3", TIMESLOT2, ROOM1
    )
...
def test_teacher_room_stability():
    ...
    lesson_in_different_room = Lesson(
        "3", "Subject3", teacher, "Group3", TIMESLOT1, ROOM2
    )
    (
...
def test_teacher_time_efficiency():
    teacher = "Teacher1"
    single_lesson_on_monday = Lesson(
        "1", "Subject1", teacher, "Group1", TIMESLOT1, ROOM1
    )
    ...
    third_tuesday_lesson_with_gap = Lesson(
        "4", "Subject4", teacher, "Group4", TIMESLOT4, ROOM1
    )
    (
        constraint_verifier.verify_that(teacher_time_efficiency)
        .given(
            single_lesson_on_monday,
            first_tuesday_lesson,
            second_tuesday_lesson,
            third_tuesday_lesson_with_gap,
        )
        .rewards_with(1)
    )  # Second tuesday lesson immediately follows the first.

    # Reverse ID order
    alt_second_tuesday_lesson = Lesson(
        "2", "Subject2", teacher, "Group3", TIMESLOT3, ROOM1
    )
    alt_first_tuesday_lesson = Lesson(
        "3", "Subject3", teacher, "Group2", TIMESLOT2, ROOM1
    )
    (
        constraint_verifier.verify_that(teacher_time_efficiency)
...
def test_student_group_subject_variety():
    ...
    monday_lesson = Lesson(
        "1", repeated_subject, "Teacher1", student_group, TIMESLOT1, ROOM1
    )
    first_tuesday_lesson = Lesson(
        "2", repeated_subject, "Teacher2", student_group, TIMESLOT2, ROOM1
    )
    second_tuesday_lesson = Lesson(
        "3", repeated_subject, "Teacher3", student_group, TIMESLOT3, ROOM1
    )
    third_tuesday_lesson_with_different_subject = Lesson(
        "4", "Subject2", "Teacher4", student_group, TIMESLOT4, ROOM1
    )
    lesson_in_another_group = Lesson(
        "5", repeated_subject, "Teacher5", "Group2", TIMESLOT1, ROOM1
    )
    (
        ...
        .given(
            ...
            first_tuesday_lesson,
            second_tuesday_lesson,
            third_tuesday_lesson_with_different_subject,
