...
TIMESLOT1 = Timeslot(
    id="1", day_of_week="MONDAY", start_time=time(12, 0), end_time=time(13, 0)
)
TIMESLOT2 = Timeslot(
    id="2", day_of_week="TUESDAY", start_time=time(12, 0), end_time=time(13, 0)
)
TIMESLOT3 = Timeslot(
    id="3", day_of_week="TUESDAY", start_time=time(13, 0), end_time=time(14, 0)
)
TIMESLOT4 = Timeslot(
    id="4", day_of_week="TUESDAY", start_time=time(15, 0), end_time=time(16, 0)
)
...
def test_student_group_conflict():
    ...
    first_lesson = Lesson(
        ...
        subject="Subject1",
        teacher="Teacher1",
        student_group=conflicting_group,
        timeslot=TIMESLOT1,
        room=ROOM1,
    )
    conflicting_lesson = Lesson(
